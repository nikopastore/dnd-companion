    ...
    <section className="grid grid-cols-12 gap-4 animate-fade-in-up">
      ...
      <div className="col-span-12 md:col-span-6 bg-surface-container-low paper-texture p-6 rounded-sm relative overflow-hidden shadow-whisper">
        ...
        <div className="mt-4 flex items-center gap-2 relative z-10">
          ...
          <button
            onClick={applyDamage}
            className="interactive-lift px-3 py-2 bg-error-container/30 text-error rounded-sm text-xs font-label uppercase flex items-center gap-1.5 border border-error/10 hover:bg-error-container/50 hover:border-error/30 hover:shadow-[0_0_15px_rgba(147,0,10,0.3)] transition-all"
          >
          ...
          <button
            onClick={applyHeal}
            className="interactive-lift px-3 py-2 bg-green-900/30 text-green-400 rounded-sm text-xs font-label uppercase flex items-center gap-1.5 border border-green-400/10 hover:bg-green-900/50 hover:border-green-400/30 hover:shadow-[0_0_15px_rgba(74,222,128,0.2)] transition-all"
          >
          ...
          <button
            onClick={addTempHP}
            className="interactive-lift px-3 py-2 bg-secondary-container/20 text-secondary rounded-sm text-xs font-label uppercase flex items-center gap-1.5 border border-secondary/10 hover:bg-secondary-container/40 hover:border-secondary/30 hover:shadow-[0_0_15px_rgba(233,195,73,0.2)] transition-all"
          >
