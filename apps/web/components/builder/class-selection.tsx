          ...
          {classes.map((cls) => {
            ...
            return (
              <button
                ...
                className={`p-6 rounded-sm text-center transition-all group ${
                  isSelected
              ...
              >
                ...
                <div className={`w-16 h-16 mx-auto mb-3 rounded-full flex items-center justify-center transition-transform ${
                  isSelected
                ...
                <span className={`font-headline text-lg block ${isSelected ? "text-secondary" : "text-on-surface"}`}>
                  {cls.name}
                </span>
          ...
          <div className="space-y-4">
            <div className="bg-surface-container-low p-6 rounded-sm space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-surface-container-high p-3 rounded-sm text-center">
            ...
            <div className="bg-surface-container-low p-6 rounded-sm space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {selectedClass.savingThrows.map((st) => (
                  <span key={st} className="px-3 py-1 rounded-xl bg-secondary-container/20 text-secondary font-label text-[10px] uppercase font-bold">
                    {st}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-surface-container-low p-6 rounded-sm space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {selectedClass.skillChoices.map((skill) => (
                  <span key={skill} className="px-3 py-1 rounded-xl bg-surface-container-high text-on-surface font-label text-[10px] uppercase">
                    {skill}
                  </span>
                ))}
              </div>
